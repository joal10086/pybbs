...
//            请求access_token
           ...
           /* String github_access_token = (String) respMap1.get("access_token");*/
            ...
            Date now = new Date();
            String access_token = StrUtil.getUUID();
            User user = User.me.findByThirdId(String.valueOf(1));
            boolean flag = true;
            if (user == null) {
                user = new User();
                user.set("in_time", now)
            ...
            user.set("nickname", "admin")
                    .set("avatar", "http://localhost:8080/static/images/upload/avatar/default.png")
